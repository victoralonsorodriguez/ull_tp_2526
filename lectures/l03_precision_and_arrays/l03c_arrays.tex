...
\begin{frame}[fragile]{Array Indexing (1/4): Single Element}
  \begin{columns}[T]
    \column{0.45\textwidth}
...
\begin{frame}[fragile]{Array Indexing (2/4): Row Section}
  \begin{columns}[T]
    \column{0.45\textwidth}
    \begin{block}{Indexing Example}
      \texttt{A(2,:)}\\[0.5em]
...
\begin{frame}[fragile]{Array Indexing (3/4): Column Section}
  \begin{columns}[T]
    \column{0.45\textwidth}
    \begin{block}{Indexing Example}
      \texttt{A(:,3)}\\[0.5em]
